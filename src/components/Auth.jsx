      ...
      <div className="container" style={{ display: 'flex', justifyContent: 'center', width: '100%', padding: '1rem' }}>
        <div className="card glass auth-card" style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', width: '100%' }}>
            <div>
              <input type="email" placeholder="name@example.com" className="input-field" style={{ height: '56px', padding: '0 1.25rem', fontSize: '1rem', width: '100%' }} value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
            {view !== 'forgot' && (
              <div>
                <input type="password" placeholder="Password" className="input-field" style={{ height: '56px', padding: '0 1.25rem', fontSize: '1rem', width: '100%' }} value={password} onChange={(e) => setPassword(e.target.value)} required />
              </div>
            )}
